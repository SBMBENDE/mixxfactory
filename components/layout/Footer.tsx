  ...
  return (
    <footer className="bg-gray-900 text-gray-100 border-t border-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 md:py-12">
        {/* Mobile: About full-width, Quick Links & For Professionals side-by-side, Legal full-width
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-12">
          ...
          {/* For Professionals - 1 col on mobile, 1 col on desktop */}
          <div className="col-span-1">
          ...
          {/* Legal Links - Full width on mobile, 1 col on desktop (LAST) */}
          <div className="col-span-2 md:col-span-1">
